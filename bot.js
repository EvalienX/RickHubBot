...
bot.on('ready', () => {
  ...
  bot.user.setPresence({
    activity: {
      name: `🔥🥺RickHub🥺🔥 | Type ${config.prefix}help for help!
      Credits- @EvalienX#2109`
    },
    status: 'online',
...
bot.on('message', async msg => {
  ...
  if (command == 'help') {
    ...
    .setFooter('© Copyright 2021 Evan Barnes. Licensed with GPL-3.0')
    .setColor('#0066ff')
  ...
  if (command == 'about') {
    msg.channel.send('The bot code was created by Evan Barnes (EvalienX#2106). Written in Discord.JS and licensed with GPL-3.0');
  }

  if (command == 'ecb') {
    msg.channel.send('Evan Carter Barnes');
  }

  if (command == 'evan?') {
    msg.channel.send('The Best Person In The World! WYM... you dont know him?');
  }
